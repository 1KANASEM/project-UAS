				...
				<div class="col-lg-4 event_col">
					<div class="event event_mid">
						...
						<div class="event_body d-flex flex-row align-items-start justify-content-start">
							...
							<div class="event_content">
								<div class="event_title"><a href="<?=base_url()?>template/front-end/#">Repaying your student loans (Winter 2017-2018)</a></div>
								<div class="event_info_container">
				...
				<div class="col-lg-4 event_col">
					<div class="event event_right">
						...
						<div class="event_body d-flex flex-row align-items-start justify-content-start">
							...
							<div class="event_content">
								<div class="event_title"><a href="<?=base_url()?>template/front-end/#">Alternative data and financial inclusion</a></div>
								<div class="event_info_container">
			...
			<div class="row team_row">
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						...
						<div class="team_body">
							<div class="team_title"><a href="<?=base_url()?>template/front-end/#">William James</a></div>
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						...
						<div class="team_body">
							<div class="team_title"><a href="<?=base_url()?>template/front-end/#">John Tyler</a></div>
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						...
						<div class="team_body">
							<div class="team_title"><a href="<?=base_url()?>template/front-end/#">Veronica Vahn</a></div>
				...
				<div class="col-lg-7 news_col">
					...
					<div class="news_post_large_container">
						<div class="news_post_large">
							...
							<div class="news_post_large_title"><a href="<?=base_url()?>template/front-end/blog_single.html">Here’s What You Need to Know About Online Testing for the ACT and SAT</a></div>
							...
							<div class="news_post_link"><a href="<?=base_url()?>template/front-end/blog_single.html">read more</a></div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-5 news_col">
					<div class="news_posts_small">
						...
						<div class="news_post_small">
							<div class="news_post_small_title"><a href="<?=base_url()?>template/front-end/blog_single.html">Home-based business insurance issue (Spring 2017 - 2018)</a></div>
							<div class="news_post_meta">
								<ul>
									<li><a href="#">admin</a></li>
									<li><a href="#">november 11, 2017</a></li>
						...
						<!-- News Posts Small -->
						<div class="news_post_small">
							<div class="news_post_small_title"><a href="<?=base_url()?>template/front-end/blog_single.html">2018 Fall Issue: Credit Card Comparison Site Survey (Summer 2018)</a></div>
							<div class="news_post_meta">
								<ul>
									<li><a href="#">admin</a></li>
									<li><a href="#">november 11, 2017</a></li>
						...
						<!-- News Posts Small -->
						<div class="news_post_small">
							<div class="news_post_small_title"><a href="<?=base_url()?>template/front-end/blog_single.html">Cuentas de cheques gratuitas una encuesta de Consumer Action</a></div>
							<div class="news_post_meta">
								<ul>
									<li><a href="#">admin</a></li>
									<li><a href="#">november 11, 2017</a></li>
						...
						<!-- News Posts Small -->
						<div class="news_post_small">
							<div class="news_post_small_title"><a href="<?=base_url()?>template/front-end/blog_single.html">Troubled borrowers have fewer repayment or forgiveness options</a></div>
							<div class="news_post_meta">
								<ul>
									<li><a href="#">admin</a></li>
									<li><a href="#">november 11, 2017</a></li>
