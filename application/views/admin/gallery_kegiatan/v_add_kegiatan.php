<div class="col-lg-12">
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            echo form_open_multipart('kegiatan/add_kegiatan/' . $gallery_kegiatan->id_gallery);
            ?>
            ...
            <?php foreach ($kegiatan as $key => $value) { ?>
                <div class="col-md-3 text-center">
                    <div class="thumbnail" style="height: 260px; overflow: hidden;">
                        ...
                        <img src="<?= base_url('foto_kegiatan/' . $value->foto) ?>"
                            style="width: 75%; height: 75%; object-fit: cover;" alt="<?= $value->keterangan ?>">
                        <div class="caption" style="margin-top: 5px;">
                            <a href="<?= base_url('kegiatan/delete_kegiatan/') . $value->id_gallery . '/' . $value->id_kegiatan ?>"
